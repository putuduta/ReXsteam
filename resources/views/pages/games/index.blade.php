                ...
                <div class="col-lg-5">
                    <form action="{{ route('games.filter') }}" method="GET">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" name="name" placeholder="Game Name" class="form-control">
                        </div>
                            ...
                            <div class="col-md-3 my-3">
                                <a href="{{ route('games.show', $game) }}" class="text-reset text-decoration-none">
                                    <div class="card card-game shadow-sm">
                                        <img src="/storage/assets/covers/{{ $game->cover }}" class="card-game-img"
                                            alt="">
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn border bg-white text-dark"
